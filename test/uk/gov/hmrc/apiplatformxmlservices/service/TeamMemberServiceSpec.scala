...
class TeamMemberServiceSpec extends AsyncHmrcSpec {
  ...
  "addCollaborator" should {
    ...
    "return Left when Organisation exists but fails to get or create user" in new Setup {
      ...
      when(mockThirdPartyDeveloperConnector.createVerifiedUser(eqTo(CreateUserRequest(anEmailAddress, aFirstName, aLastName, WrappedApiCategoryServiceMap.empty)))(*[HeaderCarrier]))
